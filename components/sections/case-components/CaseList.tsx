    ...
    >
      ...
      <div className="flex flex-col relative z-10">
        {initialCases.map((c, i) => (
          ...
          >
            <InteractiveListItem name={c.name} logo={c.logo} isExpanded={expandedIndex === i} comingSoon={c.status === "Coming Soon!"} onClick={() => toggleExpand(i)} />
          ...
          {showAll &&
            extraCases.map((c, i) => {
              ...
              return (
                ...
                >
                  <InteractiveListItem name={c.name} logo={c.logo} isExpanded={expandedIndex === actualIndex} comingSoon={c.status === "Coming Soon!"} onClick={() => toggleExpand(actualIndex)} />
