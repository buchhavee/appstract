...
export default function OfficeCard({ office, index }: OfficeCardProps) {
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: index * 0.05 }} className="p-5 bg-neutral-light/70 rounded-lg border border-black/40">
